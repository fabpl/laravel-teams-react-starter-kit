...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/fplanchette/Projects/fabpl/laravel-teams-react-starter-kit/public/storage' => 'string',
...
'filesystems.links./Users/fplanchette/Projects/fabpl/laravel-teams-react-starter-kit/public/storage','inertia.ssr.enabled','inertia.ssr.url','inertia.ensure_pages_exist','inertia.page_paths',
...
'signed','throttle','verified','current-team',);
        registerArgumentsSet('routes', 
'debugbar.openhandler','debugbar.clockwork','debugbar.assets.css','debugbar.assets.js','debugbar.cache.delete',
'debugbar.queries.explain','register','register.store','login',
'login.store','password.request','password.email','password.reset','password.store',
'password.confirm','password.confirm.store','logout','verification.send','verification.notice',
'verification.verify','teams.create','teams.store','team-invitations.accept','dashboard','profile.edit','profile.update','profile.destroy','current-team.update',
'teams.edit','teams.members','teams.destroy','teams.update','team-invitations.store',
'team-invitations.destroy','team-members.update','team-members.destroy','password.edit','password.update',
'appearance','home','storage.local',);
        registerArgumentsSet('views', 
'app','mail.team-invitation-mail','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
