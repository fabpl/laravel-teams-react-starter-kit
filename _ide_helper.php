...
namespace Illuminate\Http {
    ...
    class RedirectResponse extends \Symfony\Component\HttpFoundation\RedirectResponse {
        /**
         * @see \App\Providers\AppServiceProvider::configureFlashResponse()
         * @param string $title
         ...
         * @static
         */
        public static function flash($title, $description = null, $variant = 'default')
        {
            return \Illuminate\Http\RedirectResponse::flash($title, $description, $variant);
        }
